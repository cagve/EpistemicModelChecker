 ...
 * <br>                  "[]" "(" FORMULA ")" | "&lt;&gt;" "(" FORMULA ")" |"Kagent" "("FORMULA")" | "Magent" "(" "FORMULA" ")"
...
/**
 *  Clase que construye el parser epistémico, extiende Parser, una clase de la librería tweety. (https://tweetyproject.org/)
 *  Ahora mismo está limitado a 4 agentes. a,b,c y d.
...
public class EpistemicParser extends Parser<MlBeliefSet,RelationalFormula> {
    ...
    private void consumeToken(Stack<Object> stack, int c) throws ParserException {
        try {
            ...
            if(s.equals(" ")){
                ...
                if(stack.lastElement().equals("K")){
                    stack.pop();
                    stack.push("Ka");
                }else if(stack.lastElement().equals("M")) {
                    stack.pop();
                    stack.push("Ma");
                }else stack.push(s);
    ...
    private RelationalFormula parseModalization(List<Object> l) throws ParserException {
        if(l.isEmpty()) {
            throw new ParserException("Empty parentheses."); }
        if(!( l.contains("Ka") || l.contains("Ma") || l.contains("Mb") || l.contains("Mc") || l.contains("Md") ||l.contains("Kb")||l.contains("Kc")||l.contains("Kd") ) )
            return this.parseEquivalence(l);

        //If the modalized subformula is not the first conjunct/disjunct/subformula of
        //the formula, split the list at position of first non-quantor operator
        if (!(l.get(0).equals("Ma") || l.get(0).equals("Ka")||l.get(0).equals("Mb") || l.get(0).equals("Kb")||l.get(0).equals("Mc") || l.get(0).equals("Kc")||l.get(0).equals("Md") || l.get(0).equals("Kd"))) {
            int i1 = l.indexOf(LogicalSymbols.CONJUNCTION());
            int i2 = l.indexOf(LogicalSymbols.DISJUNCTION());
            int i3 = l.indexOf(LogicalSymbols.EQUIVALENCE());
            int i4 = l.indexOf(LogicalSymbols.IMPLICATION());
        ...
        if (l.get(0).equals("Ka"))
            result = new Knowledge((RelationalFormula) l.get(1),'a');
        else if (l.get(0).equals("Kb"))
            result = new Knowledge((RelationalFormula) l.get(1),'b');
        else if (l.get(0).equals("Kc"))
            result = new Knowledge((RelationalFormula) l.get(1),'c');
        else if (l.get(0).equals("Kd"))
            result = new Knowledge((RelationalFormula) l.get(1),'d');//MODIFICADO
        else if (l.get(0).equals("Ma"))
            result = new PosKnowledge((RelationalFormula) l.get(1),'a');//MODIFICADO
        else if (l.get(0).equals("Mb"))
            result = new PosKnowledge((RelationalFormula) l.get(1),'b');//MODIFICADO
        else if (l.get(0).equals("Mc"))
            result = new PosKnowledge((RelationalFormula) l.get(1),'c');
        else if (l.get(0).equals("Md"))
            result = new PosKnowledge((RelationalFormula) l.get(1),'d');//MODIFICADO
        else
